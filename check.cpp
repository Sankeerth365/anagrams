...
/* Your changes will not be reflected in autograder.” */
#include "check.h"
#include<iostream>
#include<cmath>
#include<string>
...
int test_sort_word(){
    int score = 0;
    GAnagramDict gold_dictionary("test1"); // Don't change filename, extension left out on purpose
    AnagramDict dictionary("test1"); // Don't change filename, extension left out on purpose
